...
function update_count(){
    ...
    if (total > 1000){
        ...
        $('#unit_footer').text('GB');
        hdunit = 'GB'
        $('#topsummary').text(how_long+'you\'ve spent '+playtimetotal+' hours playing this selection, which includes '+modgamelistvalue.length+' items, is valued at $'+pricetotal+', and requires '+total+' '+hdunit);
